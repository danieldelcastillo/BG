...
class ControlCard:
    ...
    name: str
    copies: int
    options: tuple[ControlOption, ControlOption, ControlOption]
...
def control_card_definitions() -> tuple[ControlCard, ...]:
    ...
    return (
        ...
        _control(
            ...
            Effect(yellow_cards=1, cf_bonus=2),
        ),
        _control(
            "wing_play",
            "Apertura a banda",
        ...
        _control(
            ...
            Effect(pressure_delta=-2, cc_bonus=1),
            Comparison(Attribute.MED, Attribute.MED),
            Effect(pressure_delta=-1, cc_bonus=1),
        ),
    )
...
def red_card_definitions() -> tuple[RedCard, ...]:
    ...
    return (
        _red_card(
            "ataque_banda",
            "Ataque por banda",
            _red_action(Attribute.MED, Attribute.DEF, 2, Effect(pressure_delta=5)),
        ...
        _red_card(
            ...
            Effect(discard_top_cards=1, player_yellow_cards=1),
            _red_conditional(
