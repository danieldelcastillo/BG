...
def control_card_definitions() -> tuple[ControlCard, ...]:
    ...
    return (
        ...
        _control(
            ...
            Effect(pressure_delta=2, cf_bonus=6),
            Comparison(Attribute.DEF, Attribute.MED),
            Effect(yellow_cards=1, cf_bonus=7),
        ),
        _control(
            "wing_play",
            "Apertura a banda",
        ...
        _control(
            ...
            Comparison(Attribute.MED, Attribute.DEF, 2),
            Effect(cf_bonus=7, pressure_delta=1),
        ...
        _control(
            ...
            "Centro al área",
            3,
            Effect(discard_control_cards=1, cf_bonus=3),
        ...
        _control(
            ...
            Effect(cf_bonus=4),
            Comparison(Attribute.MED, Attribute.DEF, 2),
            Effect(pressure_delta=-1, cf_bonus=2),
        ),
        _control(
            "line_breaking_pass",
            "Pase entre líneas",
            2,
            Effect(cc_bonus=4),
            Comparison(Attribute.MED, Attribute.DEF, 5),
            Effect(cf_bonus=5),
        ...
        _control(
            ...
            Effect(cf_bonus=8),
            Comparison(Attribute.AT, Attribute.DEF, 3),
            Effect(cf_bonus=6, yellow_cards=1),
        ),
        _control(
            "game_control",
            "Control del juego",
            ...
            Effect(pressure_delta=-6, cc_bonus=5),
            Comparison(Attribute.MED, Attribute.MED, -1),
            Effect(pressure_delta=-4, cc_bonus=5),
        ),
    )
...
def finalization_card_definitions() -> tuple[FinalizationCard, ...]:
    ...
    return (
        _finalization(
            "one_on_one", "Mano a mano", high_goal(Attribute.AT, 8),
            FinalizationOutcome(
        ...
        _finalization(
            ...
            FinalizationOutcome("+2 Presión", OutcomeKind.PRESSURE_REDUCTION, 1, Effect(pressure_delta=2), strict_comparison(Attribute.MED, Attribute.DEF)),
            cr(),
        ),
        _finalization(
        ...
        _finalization(
            "long_shot", "Disparo lejano", high_goal(Attribute.AT, 8),
            FinalizationOutcome(
                "+2 Presión",
                OutcomeKind.PRESSURE_REDUCTION,
                1,
        ...
        _finalization(
            ...
            FinalizationOutcome(
                ...
                strict_comparison(Attribute.MED, Attribute.DEF, 6),
            ),
            FinalizationOutcome(
                "Descarta una CC de la mano, +2 Presión",
                OutcomeKind.PRESSURE_REDUCTION,
                1,
            ...
            FinalizationOutcome(
                "+6 Presión y descarta una CC de la mano",
                OutcomeKind.PRESSURE_INCREASE,
                0,
                Effect(pressure_delta=6, discard_control_cards=1),
            ),
        ),
        _finalization(
            ...
            FinalizationOutcome(
                ...
                strict_comparison(Attribute.AT, Attribute.DEF, 8),
            ),
            FinalizationOutcome(
                "Tarjeta amarilla y +3 Presión",
...
def event_card_definitions() -> tuple[EventCard, ...]:
    ...
    return (
        ...
        _event(
            ...
            "Fuera de juego",
            4,
            Effect(discard_top_cards=1, discard_control_cards=2, pressure_delta=5),
            Effect(pressure_delta=6,discard_control_cards=1),
...
def red_card_definitions() -> tuple[RedCard, ...]:
    ...
    return (
        _red_card(
            "ataque_banda",
            "Ataque por banda",
            _red_action(Attribute.MED, Attribute.DEF, 2, Effect(pressure_delta=7)),
            _red_action(Attribute.MED, Attribute.MED, 1, Effect(pressure_delta=6)),
        ...
        _red_card(
            ...
            _red_action(
                Attribute.MED, Attribute.MED, 0,
                Effect(discard_control_cards=1, pressure_delta=7),
            ),
            _red_action(
                Attribute.MED, Attribute.MED, -4,
        ...
        _red_card(
            ...
            Effect(discard_top_cards=1, player_yellow_cards=1, pressure_delta=2),
            _red_conditional(
